...
import com.example.cart.security.jwt.AuthTokenFilter;
import com.example.cart.security.jwt.JwtAuthEntryPoint;
...
public class ShopConfig {
    ...
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http, JwtUtils jwtUtils, ShopUserDetailsService userDetailsService) throws Exception{
