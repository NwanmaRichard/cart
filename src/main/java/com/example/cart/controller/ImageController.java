...
import com.example.cart.service.image.ImageService;
...
public class ImageController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<ApiResponse> uploadImage(@RequestParam List<MultipartFile> files, @RequestParam Long productId) {
        try{
